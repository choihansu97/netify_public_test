...
function Desktop() {
  return (
    <main
      className="w-screen h-full flex flex-col justify-start items-center">
      <ScrollProvider>
        <div className="flex align-center gap-4 py-2">
          <a href="/" className="rounded bg-black px-2 py-1 text-sm font-semibold text-white shadow-sm ">데스크탑</a>
          <a href="/mobile" className="rounded bg-black px-2 py-1 text-sm font-semibold text-white shadow-sm">모바일</a>
        </div>
        <HeroSection/>
        <HeroSection2/>
        <HeroSection3/>
