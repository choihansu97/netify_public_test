    ...
    <section className="h-full w-full bg-section5-gradient-color">
      <div className="mx-auto flex flex-col items-center justify-between px-4 py-14">
        ...
        <div className="flex w-[172px] flex-col items-center gap-2">
          <button className="flex h-[50px] w-full items-center justify-center whitespace-nowrap bg-[#FFFFFF] px-6 py-3">
          ...
          <button className="flex h-[50px] w-full items-center justify-center whitespace-nowrap bg-[#FFFFFF33] px-6 py-3">
